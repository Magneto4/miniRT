...
F_IM_BONUS	= loop.c colour.c sphere.c cylinder.c cylinder2.c plane.c cone.c cone2.c shadows.c shadows2.c intersection.c texturing.c lit.c uv_coord.c normal_mapping.c
